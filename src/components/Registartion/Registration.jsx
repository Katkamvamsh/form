...
const Registration = () => {
  ...
  const formSubmitHandler = (event) => {
    ...
    if (!formData.confirmPassword) {
      showErrors.confirmPasswordError = "confirm Password is mandatory to fill";
      isValid = false;
    } else if (formData.password !== formData.confirmPassword) {
      showErrors.confirmPasswordError = "password and confirm password should match";
      isValid = false;
    }
        ...
        <div className="input-main-container">
          ...
          <div className="input-container">
            ...
            <input
              ...
              onChange={inputHandler}
            />
            <p className="error-style">{formDataError.confirmPasswordError}</p>
          </div>
     
      <div className="button-container"> 
          <button className="register-button" type="submit">Register</button>
          <button className="register-button exist-register-button" onClick={navigateToLogin}>Have account? Sign in</button>
     </div>    
        </div>
      </form>
    </Fragment>
